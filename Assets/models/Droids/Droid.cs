...
public class Droid : MonoBehaviour
{
    ...
    public void LoadDroidData(DroidData droidData)
    {
        spawnRate = droidData.SpawnRate;
        catchRate = droidData.CatchRate;
        attack = droidData.Attack;
        defense = droidData.Defense;
        hp = droidData.Hp;
        crySound = Resources.Load(droidData.CrySound) as AudioClip;
    }
}
